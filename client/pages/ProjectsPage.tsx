              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="card-glow p-6 rounded-lg hover:border-primary/70 transition-all duration-300">
                  ...
                  <p className="text-foreground/70 text-sm">
                    Expertise in building responsive, scalable web applications using modern technologies like React, JavaScript, Python, and databases. Focus on clean, maintainable code.
                  </p>
                </div>
                <div className="card-glow p-6 rounded-lg hover:border-primary/70 transition-all duration-300">
                  <h4 className="font-semibold text-primary mb-3">
                  ...
                  <p className="text-foreground/70 text-sm">
                    Building intelligent systems using machine learning for fraud detection, anomaly detection, and behavioral analytics with real-time risk assessment capabilities.
                  </p>
                </div>
                <div className="card-glow p-6 rounded-lg hover:border-primary/70 transition-all duration-300">
                  <h4 className="font-semibold text-primary mb-3">
                  ...
                  <p className="text-foreground/70 text-sm">
                    Expert in identifying and mitigating vulnerabilities, ethical hacking, penetration testing, and implementing security best practices across web and network applications.
                  </p>
                </div>
                <div className="card-glow p-6 rounded-lg hover:border-primary/70 transition-all duration-300">
                  <h4 className="font-semibold text-primary mb-3">
                  ...
                  <p className="text-foreground/70 text-sm">
                    Designing robust system architectures, integrating security throughout the development lifecycle, and implementing DevSecOps practices for production-ready applications.
                  </p>
                </div>
              </div>
            </div>
